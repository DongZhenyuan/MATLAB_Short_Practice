...
from My_model.models import FFDNet
from My_model.utils import batch_psnr, normalize, init_logger_ipol, \
...
def eval(**args):
	...
	if rgb_den:
		in_ch = 3
		model_fn = r'My_model/models/net_rgb.pth'
		...
		in_ch = 1
		model_fn = r'My_model/models/net_gray.pth'
...
def my_eval(input_path,output_path):
